...
# This will load configurations from both settings.yaml and settings-ollama.yaml,
# and open the application on http://localhost:8001.
...
# By leveraging Nomic-embed-text, PrivateGPT can quickly sift through large volumes of data
...
# Poetry simplifies the process of managing Python dependencies by using a single file (pyproject.toml)
# for defining all project requirements. It ensures that your dependencies are isolated, compatible,
# and up-to-date.


#### 5. Gradio (User Interface)
# Gradio allows you to create a web-based user interface for your machine learning application
# with minimal effort. It makes it easy to test and interact with PrivateGPT.
